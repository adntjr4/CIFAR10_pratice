...
class CNNNet_layer(CNNNet):
    '''
    5x5 filter(10ch) -> max_pool -> 3x3 filter(64ch) -> max_pool -> (120->84->10) FNN
    '''
    def __init__(self):
        super(CNNNet_3layer, self).__init__()
        self.conv1 = nn.Conv2d(3, 10, 5) # 14x14
        self.pool = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(10, 64, 3) # 6x6
        self.conv3 = nn.Conv2d(64, 128, 3) # 2x2
